...
public class CashFormSqlHelper extends FormSqlHelper {
	 static  String TABLE="cashform";	
	
	
	public static  boolean insertForm(CashFormPO po,String table) {
		TABLE=table;
		boolean flag=false;
		...
		return flag&&updateForm(po,"cashform");
	}
	...
	public static boolean updateForm(CashFormPO po,String table) {
		TABLE=table;
	    Connection conn = getConn();
	
	    String sql = "UPDATE cashform SET " ;
	...
	public static CashFormPO getForm(String id,String table) {
		TABLE=table;
...
//		    }
	...
	private static CashFormPO createPO(String mes[]) {
		CashFormPO re=new CashFormPO();
		re.setID(mes[1]);
	...
	public static String createID(FormPO po) {
		...
		int num=searchForm(key,"cashform").size()+1;
		String str = "XJFYD-"+dateNowStr+"-"+String.format("%05d", num);
		return str;
