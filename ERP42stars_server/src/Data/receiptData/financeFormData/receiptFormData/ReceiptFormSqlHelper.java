...
public class ReceiptFormSqlHelper extends FormSqlHelper {
	 static  String TABLE="receiptform";	
	
	
	public static  boolean insertForm(ReceiptFormPO po,String table) {
		TABLE=table;
		boolean flag=false;
		...
		return flag&&updateForm(po,"receiptform");
	}
	...
	public static boolean updateForm(ReceiptFormPO po,String table) {
		TABLE=table;
	    Connection conn = getConn();
	
	    String sql = "UPDATE receiptform SET " ;
	...
	public static ReceiptFormPO getForm(String id,String table) {
		TABLE=table;
		
		ReceiptFormPO re=null;
		 Connection conn = getConn();
...
//		    }
	...
	private static ReceiptFormPO createPO(String mes[]) {
		ReceiptFormPO re=new ReceiptFormPO();
		re.setID(mes[1]);
	...
	public static String createID(FormPO po) {
      ...
      String dateNowStr = sdf.format(a);  
		...
		int num=searchForm(key,"receiptform").size()+1;
		String str = "SKD-"+dateNowStr+"-"+String.format("%05d", num);
		return str;
...
//		 */
	...
	public static void main(String args[]) {
		...
		ReceiptFormPO p=new ReceiptFormPO();
		p.setID("XJFYD-20171219-00001");
		p.setState(StateOfForm.draft);
		insertForm(p,"receiptform");
	//	updateForm(p,"receiptform");
	}
