...
public class AlarmFormSqlHelper extends FormSqlHelper {
	 static  String TABLE="alarmform";	
	
	
	public static  boolean insertForm(AlarmFormPO po) {
	...
	public static boolean updateForm(AlarmFormPO po) {
	...
	public static boolean updateList(AlarmFormPO po) {
	...
	public static AlarmFormPO getForm(String id) {
		
		
		AlarmFormPO re=new AlarmFormPO();
		 Connection conn = getConn();
	...
	public static String createID(FormPO po) {
		...
		String str = "BJD-"+dateNowStr+"-"+String.format("%05d", num);
		return str;
