...
public class OverFlowSqlHelper extends FormSqlHelper {
	 static  String TABLE="overflowform";	
	
	
	public static  boolean insertForm(OverFlowFormPO po) {
	...
	public static boolean updateForm(OverFlowFormPO po) {
	...
	public static boolean updateList(OverFlowFormPO po) {
		  ...
		  Connection conn = getConn();
		    ...
		    try {
		        pstmt = (PreparedStatement) conn.prepareStatement(sql);
		        pstmt.setBytes(1, po.getByte_list());					
	...
	public static OverFlowFormPO getForm(String id) {
		
		
		OverFlowFormPO re=new OverFlowFormPO();
		 Connection conn = getConn();
		    ...
		    try {
		    	 pstmt = (PreparedStatement)conn.prepareStatement(sql);
			        ...
			        while (rs.next()) {
			    		...
			    		re.setByte_list(rs.getBytes(11));
	...
	public static String createID(FormPO po) {
		...
		String str = "BYD-"+dateNowStr+"-"+String.format("%05d", num);
		return str;
...
//		 */
	...
	public static void main(String args[]) {
		...
		OverFlowFormPO p=new OverFlowFormPO();
