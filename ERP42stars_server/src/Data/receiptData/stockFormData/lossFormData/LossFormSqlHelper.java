...
public class LossFormSqlHelper extends FormSqlHelper {
	 static  String TABLE="lossform";	
	
	
	public static  boolean insertForm(LossFormPO po) {
	...
	public static boolean updateForm(LossFormPO po) {
	...
	public static boolean updateList(LossFormPO po) {
	...
	public static LossFormPO getForm(String id) {
		
		
		LossFormPO re=new LossFormPO();
		 Connection conn = getConn();
	...
	public static String createID(FormPO po) {
		...
		String str = "BSD-"+dateNowStr+"-"+String.format("%05d", num);
		return str;
