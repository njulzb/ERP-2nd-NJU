...
public class PresentFormSqlHelper extends FormSqlHelper {
	 static  String TABLE="presentform";	
	
	
	public static  boolean insertForm(PresentFormPO po) {
	...
	public static boolean updateForm(PresentFormPO po) {
	...
	public static boolean updateList(PresentFormPO po) {
	...
	public static PresentFormPO getForm(String id) {
		
		
		PresentFormPO re=new PresentFormPO();
		 Connection conn = getConn();
	...
	public static String createID(FormPO po) {
		...
		String str = "ZSD-"+dateNowStr+"-"+String.format("%05d", num);
		return str;
...
//		 */
	...
	public static void main(String args[]) {
		...
		PresentFormPO p=new PresentFormPO();
