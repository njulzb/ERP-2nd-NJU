...
public class SaleSlipFormSqlHelper extends FormSqlHelper {
	 static  String TABLE="saleslipform";	
	
	
	public static  boolean insertForm(SaleSlipFormPO po) {
	...
	public static boolean updateForm(SaleSlipFormPO po) {
	...
	public static boolean updateList(SaleSlipFormPO po) {
		
		  Connection conn = getConn();
			
		    String sql = "UPDATE "+TABLE+" SET  goodsListByte=?" ;
	...
	public static boolean updateGiftList(SaleSlipFormPO po) {
		
		  Connection conn = getConn();
			
		    String sql = "UPDATE "+TABLE+" SET  giftListByte=?" ;
	...
	public static SaleSlipFormPO getForm(String id) {
		
		
		SaleSlipFormPO re=new SaleSlipFormPO();
		 Connection conn = getConn();
...
//		    		re.setGoodsList(rs.getBytes(11));
	...
	public static String createID(FormPO po) {
		...
		String str = "XSD-"+dateNowStr+"-"+String.format("%05d", num);
		return str;
...
//		 */
	...
	public static void main(String args[]) {
		...
		SaleSlipFormPO p=new SaleSlipFormPO();
