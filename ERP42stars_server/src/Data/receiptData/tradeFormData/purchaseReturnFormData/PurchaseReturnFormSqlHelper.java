...
public class PurchaseReturnFormSqlHelper extends FormSqlHelper {
	 static  String TABLE="purchasereturnform";	
	
	
	public static  boolean insertForm(PurchaseReturnFormPO po) {
	...
	public static boolean updateForm(PurchaseReturnFormPO po) {
	...
	public static boolean updateList(PurchaseReturnFormPO po) {
	...
	public static PurchaseReturnFormPO getForm(String id) {
		
		
		PurchaseReturnFormPO re=new PurchaseReturnFormPO();
		 Connection conn = getConn();
	...
	public static String createID(FormPO po) {
		...
		String str = "JHTHD-"+dateNowStr+"-"+String.format("%05d", num);
		return str;
...
//		 */
	...
	public static void main(String args[]) {
		...
		PurchaseReturnFormPO p=new PurchaseReturnFormPO();
