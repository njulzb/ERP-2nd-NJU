...
public class SaleReturnFormSqlHelper extends FormSqlHelper {
	 static  String TABLE="salereturnform";	
	
	
	public static  boolean insertForm(SaleReturnFormPO po) {
	...
	public static boolean updateForm(SaleReturnFormPO po) {
	    ...
	    if(po.getRejectConment()!=null)sql=sql+"rejectConment='"+po.getRejectConment()+"',";
	   	sql=sql+" moneyZheRang="+po.getMoneyZheRang();		
	   	sql=sql+", moneyStrategy="+po.getMoneyStrategy();	
	   	sql=sql+", moneyDaiJinQuan="+po.getMoneyDaiJinQuan();	
	...
	public static boolean updateList(SaleReturnFormPO po) {
		
		  Connection conn = getConn();
			
		    String sql = "UPDATE "+TABLE+" SET  goodsList=?" ;
	...
	public static boolean updateGiftList(SaleReturnFormPO po) {
		
		  Connection conn = getConn();
			
		    String sql = "UPDATE "+TABLE+" SET  giftList=?" ;
		    
		    PreparedStatement pstmt;
		    try {
		        pstmt = (PreparedStatement) conn.prepareStatement(sql);
		        pstmt.setBytes(1, po.getGiftList());					
	...
	public static SaleReturnFormPO getForm(String id) {
		
		
		SaleReturnFormPO re=new SaleReturnFormPO();
		 Connection conn = getConn();
		    ...
		    try {
		    	 pstmt = (PreparedStatement)conn.prepareStatement(sql);
			    	...
			    	//	re.setGoodsList(rs.getBytes(11));
			    		...
			    		re.setGoodsList(rs.getBytes(15));
			    		re.setGiftList(rs.getBytes(16));
			    		re.setMoneyZheRang(rs.getDouble(17));
			    		re.setMoneyStrategy(rs.getDouble(18));
			    		re.setMoneyDaiJinQuan(rs.getDouble(19));
			    		re.setComment(rs.getString(20));
...
//		    		re.setGoodsList(rs.getBytes(11));
	...
	public static String createID(FormPO po) {
		...
		String str = "XSTHD-"+dateNowStr+"-"+String.format("%05d", num);
		return str;
...
//		 */
	...
	public static void main(String args[]) {
		...
		SaleReturnFormPO p=new SaleReturnFormPO();
