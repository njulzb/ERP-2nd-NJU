...
public class PurchaseForm extends TradeForm {
	
	
	public static void main (String args[]) {
		
		
		PurchaseFormController uo= new 	PurchaseFormController ();
		
		PurchaseForm o=new 	PurchaseForm();
		o.setSumMoney(1000);
		try {
			uo.addForm(o.toVO());
	...
	public PurchaseForm(PurchaseFormVO vo) {
	...
	public PurchaseForm(PurchaseFormPO po) {
	...
	public PurchaseFormVO toVO() {
		PurchaseFormVO out =new PurchaseFormVO();
	...
	public PurchaseFormPO toPO() {
		PurchaseFormPO out =new PurchaseFormPO();
