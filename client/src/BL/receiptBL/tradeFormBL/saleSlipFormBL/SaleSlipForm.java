...
public class SaleSlipForm extends TradeForm {
	
	
	
	

	public SaleSlipForm(SaleExportFormVO vo) {
	...
	public SaleSlipForm(SaleSlipFormPO po) {
	...
	public SaleSlipFormPO toPO() {
		SaleSlipFormPO out =new SaleSlipFormPO();
